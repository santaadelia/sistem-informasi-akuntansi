@extends('layouts.app')
@section('judul','Tambah Jurnal Penyesuaian - Sistem Informasi Akuntansi')
                ...
                <div class="card shadow h-100">
                    <div class="card-header border-0">
                        <div class="d-flex flex-column flex-md-row align-items-center justify-content-center justify-content-md-between text-center text-md-left">
                            <div class="mb-3">
                                <h2 class="mb-0">Tambah Jurnal Penyesuaian</h2>
...
<div class="container-fluid mt--7">
    <div class="card bg-secondary shadow h-100">
        <div class="card-body">
            <form autocomplete="off" action="{{ route('jurnal-penyesuaian.store') }}" method="post" enctype="multipart/form-data">
                @csrf
