@extends('layouts.app')
@section('judul','Laporan Jurnal Penyesuaian - Sistem Informasi Akuntansi')
                ...
                <div class="card shadow h-100">
                    <div class="card-header border-0">
                        <div class="d-flex flex-column flex-md-row align-items-center justify-content-center justify-content-md-between text-center text-md-left">
                            <div class="mb-3">
                                <h2 class="mb-0">Laporan Jurnal Penyesuaian</h2>
                                <p class="mb-0 text-sm">Kelola Laporan Jurnal Penyesuaian</p>
                            </div>
                            <div class="mb-3">
                                <a href="{{ route('jurnal-penyesuaian.index') }}" class="btn btn-success" title="Kembali" data-toggle="tooltip"><i class="fas fa-arrow-left"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
...
<div class="container-fluid mt--7">
    <div class="card shadow">
        <div class="card-header font-weight-bold">Laporan Jurnal Penyesuaian Per ({{ date('d F Y',strtotime(request('awal'))) }} s/d {{ date('d F Y',strtotime(request('akhir'))) }})</div>
        <div class="card-body">
                ...
                <table class="table table-hover table-sm table-striped table-bordered">
                    ...
                    <tbody>
                        @php
                            $debit = 0; $kredit = 0;
                        @endphp
                        @forelse ($jurnal_penyesuaian as $item)
                            <tr>
